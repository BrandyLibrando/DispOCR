...
# application icon
icon = J:\Dev\QtProjects\THS_DispOCR\.qtcreator\Python_3_13_64_bit_venv\Lib\site-packages\PySide6\scripts\deploy_lib\pyside_icon.ico

[python]

# python path
python_path = J:\Dev\QtProjects\THS_DispOCR\.qtcreator\Python_3_13_64_bit_venv\Scripts\python.exe
...
qml_files = main.qml,roi.qml,tester.qml
